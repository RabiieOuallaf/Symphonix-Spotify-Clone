            ...
            <div class="bg-gray-900 shadow-lg rounded p-3">
                <div class="group relative">
                    ...
                    <div class="absolute bg-black rounded bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly">
                        ...
                        <button class="hover:scale-110 text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition" onclick="location.href='/playlist/{{$playlist->id}}'">
                        ...
                        <button class="hover:scale-110 text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition" id="playlist_options">
                            ...
                            <div class="dropdown hidden" id="dropdown">
                                    ...
                                    <a href="/updatePlaylist/{{$playlist->id}}" class="text-md text-yellow-500 font-semibold hover:text-yellow-700 duration-300">Update</a>
