        ...
        <div class="max-w-2xl w-full space-y-8 p-10 bg-neutral-900  rounded-xl shadow-lg z-10">
            <div class="grid  gap-8 grid-cols-1">
                <div class="flex flex-col ">
                    ...
                    <div class="mt-5">
                        <div class="form">
                            <form action="/update/band/{{$band->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="md:space-y-2 mb-3">
                                    ...
                                    <div class="flex items-center py-6">
                                        ...
                                        <label class="cursor-pointer ">
                                            ...
                                            <input type="file"name="band_banner" required='require'>
                                        </label>
                                    </div>
                                </div>
                                <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                    <div class="mb-3 space-y-2 w-full text-xs">
                                        ...
                                        <input placeholder="band Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="band_name" value="{{$band->band_name}}">
                                        <p class="text-red text-xs hidden">Please fill out this field.</p>
                                    </div>
                                    <div class="mb-3 space-y-2 w-full text-xs">
                                        <label class="font-semibold text-white py-2">Country <abbr title="required">*</abbr></label>
                                        <input placeholder="brand country :" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="band_country" value="{{$band->band_country}}">
                                        <p class="text-red text-xs hidden">Please fill out this field.</p>
                                    </div>
                                </div>
                                <div class="mb-3 space-y-2 w-full text-xs">
                                ...
                                <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    ...
                                    <div class="w-full flex flex-col mb-3">
                                        ...
                                        <input placeholder="band Name" name="memebers"class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="band_memeber" value="{{$band->memebers}}">
                                ...
                                <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                    <div class="mb-3 space-y-2 w-full text-xs">
                                        ...
                                        <input placeholder="band Name" name="band_creating_date"class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="date" value="{{$band->band_country}}">
                                        <p class="text-red text-xs hidden">Please fill out this field.</p>
                                    </div>
