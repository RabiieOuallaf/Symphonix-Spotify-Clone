                            ...
                            <form action="/playlist/update/{{$playlist->id}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    <div class="w-full flex flex-col mb-3">
                                        ...
                                        <input placeholder="playlist Name" name="playlist_name" value="{{$playlist->playlist_name}}"class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" >
                                    </div>
                                </div>
